...
// Main navigation structure for the new simplified menu
...
export const pomocDrogowaItems = [
  { name: "Pomoc drogowa z OC", href: "/pomoc-drogowa" },
  { name: "Holowanie po wypadku", href: "/holowanie-po-wypadku-awarii-kolizji" },
  ...
  { name: "Podstawienie lawety", href: "/podstawienie-lawety-i-naprawa-na-miejscu" },
...
export const naprawyPowypadkoweItems = [
  ...
  { name: "Naprawy z OC sprawcy", href: "/naprawy-z-oc-sprawcy" },
  { name: "Blacharstwo samochodowe", href: "/blacharstwo-samochodowe" },
  { name: "Lakiernictwo samochodowe", href: "/lakiernictwo-samochodowe" },
  { name: "Mechanika samochodowa", href: "/mechanika-samochodowa-po-wypadku" },
  { name: "Przeglądy i serwis", href: "/przeglady-i-serwis-ogolny" },
];

export const autoZastepczeItems = [
  { name: "Auto zastępcze z OC", href: "/auto-zastepcze" },
  { name: "Wynajem aut z OC sprawcy", href: "/wynajem-aut-z-oc-sprawcy" },
  ...
  { name: "Wynajem specjalistyczny", href: "/wynajem-specjalistyczny-z-oc-sprawcy" },
