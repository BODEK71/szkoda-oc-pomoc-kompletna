  ...
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
        <div className="absolute -top-1/2 -left-1/2 w-full h-full bg-gradient-to-br from-blue-50/30 to-transparent rounded-full transform rotate-12"></div>
            ...
            >
              ...
              <CardHeader className="relative z-10 pb-4">
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  <div>
                    <CardTitle className="text-2xl font-bold text-autoram-text group-hover:text-blue-600 transition-colors duration-300">
                      {service.title}
                    </CardTitle>
                  </div>
                </div>
              ...
              <CardContent className="relative z-10">
                ...
                <Link to={service.link}>
                  <Button 
                    variant="outline"
                    className="w-full border-2 border-blue-500 text-blue-600 hover:bg-blue-500 hover:text-white font-semibold py-6 text-lg group-hover:scale-105 transition-all duration-300"
                  >
                    Dowiedz się więcej
