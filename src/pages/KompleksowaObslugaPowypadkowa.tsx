...
const KompleksowaObslugaPowypadkowa = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-teal-50 via-white to-teal-50 py-20 pt-32">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
                  <span className="text-teal-600">Kompleksowa obsługa powypadkowa</span>
                </h1>
                
                <h2 className="text-2xl font-semibold text-gray-800">
                  Obsługa od A do Z - Twój partner w trudnych chwilach
                </h2>
          ...
          <div className="space-y-16">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">
                Co zawiera nasz pakiet usług powypadkowych?
              </h3>
            ...
            <div className="bg-gray-50 p-12 rounded-2xl">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">
                Dlaczego warto wybrać naszą pełną obsługę?
              </h3>
              
              <div className="grid md:grid-cols-3 gap-8 text-center">
                <div>
                  <Award className="w-16 h-16 text-teal-600 mx-auto mb-4" />
                  <h4 className="text-xl font-bold text-gray-900 mb-2">Doświadczenie i profesjonalizm</h4>
                ...
                <div>
                  ...
                  <h4 className="text-xl font-bold text-gray-900 mb-2">Indywidualne podejście</h4>
                  <p className="text-gray-600">
                ...
                <div>
                  ...
                  <h4 className="text-xl font-bold text-gray-900 mb-2">Obsługa od A do Z bez ukrytych kosztów</h4>
                  <p className="text-gray-600">
