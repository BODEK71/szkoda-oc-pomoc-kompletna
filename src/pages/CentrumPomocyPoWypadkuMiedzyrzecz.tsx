...
const CentrumPomocyPoWypadkuMiedzyrzecz = () => {
  const services = [
    {
      icon: <Headphones className="w-6 h-6" />,
      title: "Infolinia powypadkowa",
      description: "Całodobowa linia pomocy dla poszkodowanych w Międzyrzeczu"
    },
    {
      icon: <Shield className="w-6 h-6" />,
      title: "Wsparcie na miejscu",
      description: "Szybki dojazd do miejsca wypadku w Międzyrzeczu"
    },
    {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                <Badge className="bg-cyan-100 text-cyan-800">
                  🏥 CENTRUM POMOCY MIĘDZYRZECZ
                </Badge>
                
                <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
                  <span className="text-cyan-600">Centrum pomocy</span>
                  <br />
                  <span className="text-gray-900">po wypadku Międzyrzecz</span>
                </h1>
                
                <p className="text-xl text-gray-600 leading-relaxed">
                  Regionalne centrum pomocy dla poszkodowanych w wypadkach komunikacyjnych 
                  w Międzyrzeczu i całym województwie lubuskim.
                </p>
              </div>
            ...
            <div className="relative">
              <img
                ...
                alt="Centrum pomocy po wypadku Międzyrzecz"
...
export default CentrumPomocyPoWypadkuMiedzyrzecz;
