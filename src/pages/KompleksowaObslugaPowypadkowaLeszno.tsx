...
const KompleksowaObslugaPowypadkowaLeszno = () => {
  const services = [
    {
      icon: <Shield className="w-6 h-6" />,
      title: "Obsługa szkód OC",
      description: "Pełne wsparcie w procesie likwidacji szkód w Lesznie"
    },
    {
    ...
    },
    {
      ...
      description: "Profesjonalne usługi bezpośrednio w Lesznie"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-orange-50 via-white to-orange-50 py-20 pt-36">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
                  <span className="text-orange-600">Kompleksowa obsługa</span>
                  <br />
                  <span className="text-gray-900">powypadkowa Leszno</span>
                </h1>
                
                <p className="text-xl text-gray-600 leading-relaxed">
                  Profesjonalna obsługa powypadkowa w Lesznie i okolicach. 
                  Lokalne centrum pomocy w powiecie leszczyńskim.
                </p>
              </div>

              <div className="grid sm:grid-cols-2 gap-4">
                {[
                  "Lokalna obsługa w Lesznie",
            ...
            <div className="relative">
              <img
                ...
                alt="Kompleksowa obsługa powypadkowa Leszno"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Kompleksowa obsługa powypadkowa w sercu powiatu leszczyńskiego
            </p>
          </div>
...
export default KompleksowaObslugaPowypadkowaLeszno;
