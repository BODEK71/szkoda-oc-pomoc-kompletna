...
const KompleksowaObslugaPowypadkowaSlawa = () => {
  const services = [
    {
      icon: <Shield className="w-6 h-6" />,
      title: "Obsługa szkód OC",
      description: "Pełne wsparcie w procesie likwidacji szkód w Sławie"
    },
    {
    ...
    },
    {
      ...
      description: "Profesjonalne usługi bezpośrednio w Sławie"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-indigo-50 via-white to-indigo-50 py-20 pt-36">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
                  <span className="text-indigo-600">Kompleksowa obsługa</span>
                  <br />
                  <span className="text-gray-900">powypadkowa Sława</span>
                </h1>
                
                <p className="text-xl text-gray-600 leading-relaxed">
                  Profesjonalna obsługa powypadkowa w Sławie i okolicach. 
            ...
            <div className="relative">
              <img
                ...
                alt="Kompleksowa obsługa powypadkowa Sława"
...
export default KompleksowaObslugaPowypadkowaSlawa;
