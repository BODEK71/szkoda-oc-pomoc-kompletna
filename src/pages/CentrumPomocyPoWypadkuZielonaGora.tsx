...
const CentrumPomocyPoWypadkuZielonaGora = () => {
  const services = [
    {
      icon: <Headphones className="w-6 h-6" />,
      title: "Infolinia powypadkowa",
      description: "Całodobowa linia pomocy dla poszkodowanych w Zielonej Górze"
    },
    {
      icon: <Shield className="w-6 h-6" />,
      title: "Wsparcie na miejscu",
      description: "Szybki dojazd do miejsca wypadku w Zielonej Górze"
    },
    {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img
                ...
                alt="Centrum pomocy po wypadku Zielona Góra"
...
export default CentrumPomocyPoWypadkuZielonaGora;
