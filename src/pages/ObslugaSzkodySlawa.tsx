...
const ObslugaSzkodySlawa = () => {
  const localServices = [
    {
      icon: <Car className="w-6 h-6" />,
      title: "Auto zastępcze w Sławie",
      description: "Bezgotówkowy wynajem pojazdu zastępczego na czas naprawy"
    },
    {
      icon: <Shield className="w-6 h-6" />,
      title: "Holowanie w regionie",
      description: "Transport uszkodzonego pojazdu do warsztatu w Sławie"
    },
    {
      icon: <Clock className="w-6 h-6" />,
      title: "Ekspresowa likwidacja",
      description: "Szybka obsługa szkód dla mieszkańców Sławy"
    }
  ];
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
                  ...
                  <br />
                  <span className="text-gray-900">Sława</span>
                </h1>
                
                <p className="text-xl text-gray-600 leading-relaxed">
                  Kompleksowa obsługa szkód komunikacyjnych w Sławie i okolicach. 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Nasze usługi w Sławie
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Specjalizujemy się w obsłudze mieszkańców Sławy
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-purple-50 rounded-2xl p-8">
            <div className="flex items-start space-x-4">
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-bold text-gray-900">Sława i okolice</h3>
                <p className="text-gray-700 leading-relaxed">
                  Świadczymy usługi dla mieszkańców Sławy oraz okolicznych miejscowości. 
...
export default ObslugaSzkodySlawa;
